            ...
            <div className=' h-screen flex justify-center items-center'>
                ...
                <div>
                    ...
                    <div className=' flex justify-center flex-wrap  gap-5'>
                        <ServicesCard >
                            <Link to='/quotes/create/123456789' >
                        ...
                        <ServicesCard >
                            <div className=' '>
                                ...
                                <p className=' text-sm  text-center'>CNC Machining</p>
                            </div>
                        </ServicesCard>
                        <ServicesCard >
                            <div className=' '>
                                ...
                                <p className=' text-sm  text-center'>Injection Molding</p>
                            </div>
                        </ServicesCard>
                        <ServicesCard >
                            <div className=' '>
                                ...
                                <p className=' text-sm  text-center'>Sheet Metal Fabrication</p>
                            </div>
                        </ServicesCard>
                    </div>
                </div>
