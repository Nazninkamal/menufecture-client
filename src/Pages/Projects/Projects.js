...
const Projects = () => {
   ...
   <Link to="/newProject">
      <img src={add} alt="" className='mx-auto w-20 h-20'  />
    ...
    <p className="mb-3 font-normal text-gray-500 dark:text-gray-400 text-center">Go to this step by step guideline process on how to create your customize project</p>
    </Link>
