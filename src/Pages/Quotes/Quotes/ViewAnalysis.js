...
const ViewAnalysis = () => {
    ...
    return (
        <div className=' grid grid-cols-12 p-5 gap-5'>
            <div className=' col-span-12 sm:col-span-12 md:col-span-4 lg:col-span-4 md:h-screen border overflow-y-auto'>
                ...
                <a href={data?.result?.threeDFile?.fileURL} download
                    className='flex items-center justify-center  w-full text-slate-50 font-extrabold latter tracking-wider p-2 border bg-gradient-to-r from-cyan-500 to-blue-500 rounded-md active:ring-2 active:ring-offset-1   text-sm active:bg-gradient-to-l no-underline'
                >Download file</a>
            </div>
